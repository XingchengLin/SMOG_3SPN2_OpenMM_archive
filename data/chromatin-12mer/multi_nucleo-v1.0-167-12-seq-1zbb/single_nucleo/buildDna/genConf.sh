...
python2 ${spn2cdir}/utils/make_bp_params.py dnaSeq.txt 
x3dna_utils cp_std BDNA
rebuild -atomic bp_step.par atomistic.pdb

python2 ${spn2cdir}/utils/pdb2cg_dna.py atomistic.pdb 
...
python2 ${spn2cdir}/utils/make_list_files.py bdna_curv_conf_4list.in 
